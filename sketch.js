...
function draw() {
    ...
    if(balls!=null) {
        ...
        if(balls.body.position.y > 450) {
            ...
            //the balls should become null
            //if the count is greater than or equal to 5 then the gamestate should become end          
           else if(balls.body.position.x >50 && balls.body.position.x <=100) {
                score=score+ 300;                
                balls=null;
                if(count>= 5) { 
                    gameState = "end";
            ...
            //the balls should become null
            //if the count is greater than or equal to 5 then the gamestate should become end
            else if(balls.body.position.x > 100 && balls.body.position.x <=150) {
                score=score+ 200;
                balls = null;
                if(count>= 5) { 
                    gameState = "end";
            ...
            //the balls should become null
            //if the count is greater than or equal to 5 then the gamestate should become end
            else if(balls.body.position.x > 150 && balls.body.position.x <=200) {
                score=score+ 200;
                balls = null;
                if(count>= 5) {
                    gameState = "end";
            ...
            else if(balls.body.position.x > 200 && balls.body.position.x <=250) {
                score=score+ 200;
                balls = null;
                if(count>= 5) {
                    gameState = "end";
            ...
            else if(balls.body.position.x > 250) {
                score=score+ 200;
                balls = null;
                if(count>= 5) {
                    gameState = "end";
